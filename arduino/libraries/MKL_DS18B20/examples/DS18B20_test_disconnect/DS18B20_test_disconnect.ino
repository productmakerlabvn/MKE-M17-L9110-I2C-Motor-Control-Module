//
//    FILE: MKL_DS18B20_test_disconnect.ino
//  AUTHOR: Rob Tillaart
// PURPOSE: Minimal MKL_DS18B20 lib with async support.
...
void setup()
{
  ...
  sensor.setConfig(MKL_DS18B20_CRC);  // or 1
